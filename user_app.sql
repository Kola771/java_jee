...
-- Listage de la structure de la base pour user_app
CREATE DATABASE IF NOT EXISTS `user_app` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `user_app`;

-- Listage de la structure de la table user_app. users
