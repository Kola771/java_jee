...
<body>
	...
	<main>
		<h2>Page d'insertion d'utilisateurs</h2>
		<form class="formulaire" method="post" action="register">
			<div class="mb-3">
				<label for="name" class="form-label">Nom de l'utilisateur</label> <input
					type="text" class="form-control" name="name" id="name"
					aria-describedby="nameHelp">
				<div id="nameHelp" class="form-text">We'll never share your
					name with anyone else.</div>
			</div>
			<div class="mb-3">
				<label for="email" class="form-label">Adresse électronique</label> <input
			...
			<div class="mb-3">
				<label for="country" class="form-label">Pays de provenance</label> 
				<select
				...
				<div id="country" class="form-text">We'll never share your
					country with anyone else.</div>
			</div>
